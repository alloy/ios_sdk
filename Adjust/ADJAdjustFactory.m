                                            ...
                                            startsSending:(BOOL)startsSending
{
    if (internalSdkClickHandler == nil) {
        return [ADJSdkClickHandler handlerWithStartsSending:activityHandler startsSending:startsSending];
    }

    return [internalSdkClickHandler initWithStartsSending:activityHandler startsSending:startsSending];
}
